...
- dashboard: income_statement_template
  ...
  - name: Select Fiscal Timeframe
    ...
    default_value: "{% if _user_attributes['lap_lam_sap_use_demo_data']=='Yes'%}{% assign qtr = '2023.Q4'%}{%else%}{% assign q = 'now' | date: '%m' | times: 1.0 | divided_by: 3 | ceil %}{% assign qtr = 'now' | date: '%Y' | append: '.Q' | append: q %}{%endif%}{{qtr}}"
