...
- dashboard: balance_sheet_template
  ...
  - name: Chart of Accounts
    ...
    type: field_filter
    default_value: "{% if _user_attributes['lap_lam_sap_sql_flavor']=='S4' %}{% assign coa = 'YCOA'%}{%elsif _user_attributes['lap_lam_sap_sql_flavor']=='ECC'%}{% assign coa = 'CA01' %}{%else%}{%assign coa = 'something else'%}{% endif %}{{coa}}"
    allow_multiple_values: false
    required: true
    ui_config:
      type: dropdown_menu
