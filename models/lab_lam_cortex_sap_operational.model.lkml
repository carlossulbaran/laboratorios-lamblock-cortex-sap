...
explore: produccion_kpi2 {
  from: produccion_kpi2
}
...
explore: sales_orders {
  ...
  sql_always_where: ${client_mandt}='{{ _user_attributes['lap_lam_client_id_rep'] }}' ;;
...
explore: accounts_payable_v2 {
  ...
  sql_always_where: ${accounts_payable_v2.client_mandt} =  '{{ _user_attributes['lap_lam_client_id_rep'] }}';;
}
...
explore: accounts_payable_overview_v2 {
  ...
  sql_always_where: ${accounts_payable_overview_v2.client_mandt} =  '{{ _user_attributes['lap_lam_client_id_rep'] }}' ;;
}

explore: accounts_payable_turnover_v2 {

  sql_always_where: ${accounts_payable_turnover_v2.client_mandt} = '{{ _user_attributes['lap_lam_client_id_rep'] }}' ;;
}
